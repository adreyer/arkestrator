...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'board.post': {
            ...
            'deleted_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'deleted_posts'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'thread': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['board.Thread']"})
        },
        'board.thread': {
            ...
            'deleted_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'deleted_threads'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'pms_received'", 'null': 'True', 'to': "orm['auth.User']"}),
