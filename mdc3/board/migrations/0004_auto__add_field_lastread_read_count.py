...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LastRead.read_count'
        db.add_column('board_lastread', 'read_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LastRead.read_count'
        db.delete_column('board_lastread', 'read_count')
