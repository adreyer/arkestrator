...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Thread.stuck'
        db.add_column('board_thread', 'stuck', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Thread.stuck'
        db.delete_column('board_thread', 'stuck')
