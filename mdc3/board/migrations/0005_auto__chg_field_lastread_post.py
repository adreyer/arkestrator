...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LastRead.post'
        db.alter_column('board_lastread', 'post_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.Post'], null=True))


    def backwards(self, orm):
        
        # Changing field 'LastRead.post'
        db.alter_column('board_lastread', 'post_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.Post']))
