...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Thread.subject'
        db.alter_column('board_thread', 'subject', self.gf('django.db.models.fields.CharField')(max_length=160))


    def backwards(self, orm):
        
        # Changing field 'Thread.subject'
        db.alter_column('board_thread', 'subject', self.gf('django.db.models.fields.CharField')(max_length=60))
