...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field favorite on 'Thread'
        db.create_table('board_thread_favorite', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('thread', models.ForeignKey(orm['board.thread'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('board_thread_favorite', ['thread_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field favorite on 'Thread'
        db.delete_table('board_thread_favorite')
