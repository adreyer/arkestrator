...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.all_markets'
        db.add_column('events_event', 'all_markets', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.all_markets'
        db.delete_column('events_event', 'all_markets')
