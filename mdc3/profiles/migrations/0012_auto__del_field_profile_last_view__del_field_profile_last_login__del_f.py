...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.last_view'
        db.delete_column('profiles_profile', 'last_view')

        # Deleting field 'Profile.last_login'
        db.delete_column('profiles_profile', 'last_login')

        # Deleting field 'Profile.last_post'
        db.delete_column('profiles_profile', 'last_post')


    def backwards(self, orm):
        
        # Adding field 'Profile.last_view'
        db.add_column('profiles_profile', 'last_view', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'Profile.last_login'
        db.add_column('profiles_profile', 'last_login', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'Profile.last_post'
        db.add_column('profiles_profile', 'last_post', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)
    ...
    models = {
        ...
        'profiles.profile': {
            ...
            'favs_first': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'gtalk_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'invite_used': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['invites.Invite']", 'null': 'True', 'blank': 'True'}),
            ...
            'market': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['events.Market']", 'null': 'True', 'blank': 'True'}),
            ...
            'time_zone': ('django.db.models.fields.CharField', [], {'default': "'America/New_York'", 'max_length': '20'}),
