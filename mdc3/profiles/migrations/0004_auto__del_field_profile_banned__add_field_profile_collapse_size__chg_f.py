...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('profiles_profile', 'banned')

        # Adding field 'Profile.collapse_size'
        db.add_column('profiles_profile', 'collapse_size', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)

        # Changing field 'Profile.info'
        db.alter_column('profiles_profile', 'info', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Adding field 'Profile.banned'
        db.add_column('profiles_profile', 'banned', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Profile.collapse_size'
        db.delete_column('profiles_profile', 'collapse_size')

        # Changing field 'Profile.info'
        db.alter_column('profiles_profile', 'info', self.gf('django.db.models.fields.CharField')(max_length=2500))
