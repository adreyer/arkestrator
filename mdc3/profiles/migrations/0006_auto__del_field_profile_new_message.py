...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.new_message'
        db.delete_column('profiles_profile', 'new_message')


    def backwards(self, orm):
        
        # Adding field 'Profile.new_message'
        db.add_column('profiles_profile', 'new_message', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
