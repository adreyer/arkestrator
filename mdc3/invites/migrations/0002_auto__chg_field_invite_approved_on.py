...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invite.approved_on'
        db.alter_column('invites_invite', 'approved_on', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Invite.approved_on'
        db.alter_column('invites_invite', 'approved_on', self.gf('django.db.models.fields.DateTimeField')())
