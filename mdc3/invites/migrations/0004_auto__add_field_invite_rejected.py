...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invite.rejected'
        db.add_column('invites_invite', 'rejected', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invite.rejected'
        db.delete_column('invites_invite', 'rejected')
