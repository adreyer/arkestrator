...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invite.explanation'
        db.alter_column('invites_invite', 'explanation', self.gf('django.db.models.fields.CharField')(max_length=2500))


    def backwards(self, orm):
        
        # Changing field 'Invite.explanation'
        db.alter_column('invites_invite', 'explanation', self.gf('django.db.models.fields.CharField')(max_length=150))
    ...
    models = {
        ...
        'invites.invite': {
            ...
            'explanation': ('django.db.models.fields.CharField', [], {'max_length': '2500', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
