...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invite.approved_by'
        db.add_column('invites_invite', 'approved_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='approved_invite', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invite.approved_by'
        db.delete_column('invites_invite', 'approved_by_id')
