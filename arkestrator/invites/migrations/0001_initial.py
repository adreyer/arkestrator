...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('invites_invite', (
            ...
            ('invitee', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('explanation', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('approved', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('approved_on', self.gf('django.db.models.fields.DateTimeField')()),
            ('invite_code', self.gf('django.db.models.fields.CharField')(max_length=25)),
    ...
    models = {
        ...
        'invites.invite': {
            ...
            'approved_on': ('django.db.models.fields.DateTimeField', [], {}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'explanation': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_code': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
