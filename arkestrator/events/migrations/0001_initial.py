...
class Migration(SchemaMigration):
    depends_on = ( 
        ("board", "0009_auto__chg_field_post_bbhash.py"),
    )

    def forwards(self, orm):
        
        # Adding model 'Market'
        db.create_table('events_market', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('timezone', self.gf('django.db.models.fields.CharField')(default='US/Eastern', max_length=50)),
        ))
        db.send_create_signal('events', ['Market'])

        # Adding model 'Event'
        db.create_table('events_event', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('thread', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['board.Thread'], unique=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=160)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')()),
            ('location', self.gf('django.db.models.fields.TextField')(null=True)),
            ('market', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Market'])),
