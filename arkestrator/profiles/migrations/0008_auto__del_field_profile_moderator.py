...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.moderator'
        db.delete_column('profiles_profile', 'moderator')


    def backwards(self, orm):
        
        # Adding field 'Profile.moderator'
        db.add_column('profiles_profile', 'moderator', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
