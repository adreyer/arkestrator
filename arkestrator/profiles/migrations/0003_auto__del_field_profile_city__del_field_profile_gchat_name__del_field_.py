...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.gchat_name'
        db.delete_column('profiles_profile', 'gchat_name')

        # Deleting field 'Profile.zip_code'
        db.delete_column('profiles_profile', 'zip_code')

        # Deleting field 'Profile.security_answer'
        db.delete_column('profiles_profile', 'security_answer')

        # Adding field 'Profile.gtalk_name'
        db.add_column('profiles_profile', 'gtalk_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Profile.city'
        db.add_column('profiles_profile', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Profile.gchat_name'
        db.add_column('profiles_profile', 'gchat_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Profile.zip_code'
        db.add_column('profiles_profile', 'zip_code', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Profile.security_answer'
        db.add_column('profiles_profile', 'security_answer', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Deleting field 'Profile.gtalk_name'
        db.delete_column('profiles_profile', 'gtalk_name')
