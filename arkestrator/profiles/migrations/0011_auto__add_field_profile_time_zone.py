...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_profile', 'time_zone', self.gf('django.db.models.fields.CharField')(default='America/New_York', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.time_zone'
        db.delete_column('profiles_profile', 'time_zone')
