...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.favs_first'
        db.add_column('profiles_profile', 'favs_first', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.favs_first'
        db.delete_column('profiles_profile', 'favs_first')
