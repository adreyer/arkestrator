...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('board_thread', 'recipient', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pms_received', null=True, to=orm['auth.User']), keep_default=False)
