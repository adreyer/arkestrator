...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.bbhash'
        db.alter_column('board_post', 'bbhash', self.gf('django.db.models.fields.CharField')(max_length=40))


    def backwards(self, orm):
        
        # Changing field 'Post.bbhash'
        db.alter_column('board_post', 'bbhash', self.gf('django.db.models.fields.CharField')(max_length=20))
