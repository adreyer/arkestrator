...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.bbhash'
        db.add_column('board_post', 'bbhash', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.bbhash'
        db.delete_column('board_post', 'bbhash')
    ...
    models = {
        ...
        'board.post': {
            ...
            'bbhash': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
